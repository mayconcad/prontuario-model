...
public class Responsavel extends BaseEntity {
	 ...
	 * @param user
	 */
	public Responsavel(long idExterno, String nome, String matriculaFuncional,
			String cpf, String rg, String orgaoExpedidor, String dataExpedicao,
			long idCargo, String cargo, String endereco, String cidade,
			String bairro, String uf, String telefone, Date dataInicial,
			Date dataFinal, String codigoBanco, String numeroConta,
			TipoContaEnum tipoConta, String digitoConta, String numeroAgencia,
			String digitoAgencia, long codigoCredor, User user) {
		super();
